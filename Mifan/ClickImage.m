...
//                        
//                        
////                        UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:clickViewController];
////                        
////                        [((UIViewController*)nextResponder) presentViewController:nav animated:NO completion:^{
////                            ;
////                        }];//可更改为UINavigation推入
//                        
//                    }
...
//    }
    ...
    oldframe=[defaultImageView convertRect:defaultImageView.bounds toView:window];
